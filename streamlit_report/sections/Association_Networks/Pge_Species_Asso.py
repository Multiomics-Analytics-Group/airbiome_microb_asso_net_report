...
selected_sheet = 0
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/1_PGE_sp_metrics_asso.xlsx').resolve()
...
file_path = (section_dir / '../static/Cclasso_Nosinglt_55_Edgelist.html').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/3_module_means.csv').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/4_module_means_heatmap.json').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/5_violin_plot_module_variability.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/6_module_metadata_correlations.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/7_correlation_volcano_plot.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/8_significant_module_metadata_corr.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/9_top_correlations_heatmap.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
