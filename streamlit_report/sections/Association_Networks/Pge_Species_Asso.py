...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/3_module_taxa_membership.csv').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/4_module_means.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/5_module_means_heatmap.json').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/6_module_variability.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/7_module_metadata_correlations.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/8_module_metadata_correlations_volcano_plot.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/9_significant_module_metadata_correlations.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Association_networks/PGE_species_asso/10_top_correlations_heatmap.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
