...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_genus_adj/3_module_taxa_membership.csv').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_genus_adj/6_module_variability.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_genus_adj/9_significant_module_metadata_correlations.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_genus_adj/10_top_correlations_heatmap.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
