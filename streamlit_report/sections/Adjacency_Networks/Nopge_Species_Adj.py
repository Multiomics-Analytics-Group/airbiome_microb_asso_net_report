...
st.markdown(("<p style='text-align: center; color: black;'> "
            "<b>Number of nodes:</b> 54 </p>"),
            unsafe_allow_html=True)
st.markdown(("<p style='text-align: center; color: black;'>"
             " <b>Number of relationships:</b> 142"
             " </p>"),
            unsafe_allow_html=True)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_species_adj/3_centrality_metrics_all_nodes.csv').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_species_adj/4_module_taxa_membership.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_species_adj/5_module_means.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_species_adj/6_module_means_heatmap.json').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_species_adj/7_module_variability.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_species_adj/8_module_metadata_correlations.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_species_adj/9_module_metadata_correlations_volcano_plot.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/NOPGE_species_adj/10_top_correlations_heatmap.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
