...
selected_sheet = 0
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/PGE_genus_adj/1_PGE_gen_metrics_adj.xlsx').resolve()
...
file_path = (section_dir / '../static/Cclasso_Nosinglt_45_Edgelist.html').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/PGE_genus_adj/3_module_means.csv').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/PGE_genus_adj/4_module_means_heatmap.json').resolve().as_posix()
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/PGE_genus_adj/5_violin_plot_module_variability.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/PGE_genus_adj/6_module_metadata_correlations.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/PGE_genus_adj/7_correlation_volcano_plot.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/PGE_genus_adj/8_significant_module_metadata_corr.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../AirBiome_microbial_association_networks_summary/Adjacency_networks/PGE_genus_adj/9_top_correlations_heatmap.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
